...
public class ListOfMapPractice1 {
    ...
    public static void main(String[] args) {
        ...
        scrumTeams.add(scrumTeam1); //scrumTeam1 reference type is MAP, thats why you need to create List of Map in line 54
        ...
        //now size of the list scrumTeams is 1 cause you added only 1 scrumTeam1
