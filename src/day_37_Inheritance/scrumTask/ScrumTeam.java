...
public class ScrumTeam {
    ...
    //you are just adding, not returning any data thats why void
    public void addTester(Tester tester){
        testers.add(tester);
    }

    public void addTesters(Tester [] testers){
        this.testers.addAll(Arrays.asList(testers));        //this keyword cause "testers" is the same name of local and instance variable here, thats why you need to use it or change the name in parenthesis
    }
