...
public class IterableINTERVIEW {
    ...
    public static void main(String[] args) {
        ...
        //INTERVIEW: remove all the names "ahmet" -> no lambda use!

        //names.removeAll(Arrays.asList("Ahmet"));    //not an option cause it will not delete names like "aHmEd"!!!!!
       ...
       while (it.hasNext()){
        ...
        names2.addAll(Arrays.asList("Ahmed", "ahmed", "aHmEd", "John", "Ercon", "Daniel", "Mustafa", "Mohammed", "Ahmed", "ahmed", "Yulia"));
        ...
        names3.addAll(Arrays.asList("Ahmed", "ahmed", "aHmEd", "John", "Ercon", "Daniel", "Mustafa", "Mohammed", "Ahmed", "ahmed", "Yulia"));
